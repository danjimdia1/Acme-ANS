...
public class CustomerPassengerPublishService extends AbstractGuiService<Customer, Passenger> {
	...
	public void authorise() {
		...
		boolean status = passenger != null && super.getRequest().getPrincipal().hasRealm(customer) && super.getRequest().getPrincipal().getActiveRealm().getId() == passenger.getCustomer().getId();
